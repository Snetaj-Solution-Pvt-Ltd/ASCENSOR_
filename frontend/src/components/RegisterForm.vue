    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
      <div class="flex justify-center mb-4">
        <svg class="h-12" viewBox="0 0 1828 251" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
          ...
          <path
            ...
            fill="#2c73d7" fill-rule="nonzero" opacity=".85"></path>
          <path d="M205.037 247.135h51.033L152.832 3.514h-50.029l102.234 243.621z" fill="#2c73d7" fill-rule="nonzero">
          </path>
        </svg>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="text-left">
        <div class="mb-4">
          ...
          <input v-model="fullName" type="text" required class="mt-1 p-2 w-full border rounded-md" />
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input v-model="password" type="password" required class="mt-1 p-2 w-full border rounded-md" />
        </div>
